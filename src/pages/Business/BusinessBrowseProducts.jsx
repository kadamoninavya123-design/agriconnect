      ...
      <div className="browse-page">
          ...
          >
            ...
            <div className="browse-order-modal">
              ...
              <p className="browse-modal-note">
                Your delivery coordinates are
                saved with this order so the farmer
                can deliver to the correct destination.
              </p>
        ...
        <style>{`
          ...
          .browse-live-badge span {
            ...
            border-radius: 50%;
            background: #75a64d;
            box-shadow: 0 0 0 3px rgba(117,166,77,.12);
          }
